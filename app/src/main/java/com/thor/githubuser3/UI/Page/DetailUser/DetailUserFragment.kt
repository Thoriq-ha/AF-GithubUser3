...
import com.thor.githubuser3.UI.Page.DetailUser.TabFollow.FollowTabPagerAdapter
import com.thor.githubuser3.UI.ViewModel.DetailUserViewModel
import com.thor.githubuser3.UI.ViewModel.FavoriteState
import com.thor.githubuser3.UI.ViewModel.ProfileState
...
class DetailUserFragment : Fragment(R.layout.fragment_detail_user) {
    ...
    override fun onOptionsItemSelected(item: MenuItem): Boolean {
        return when (item.itemId) {
            R.id.favorite_active -> {
                Toast.makeText(requireContext(), "User unsaved", Toast.LENGTH_SHORT).show()
            ...
            R.id.favorite_nonactive -> {
                Toast.makeText(requireContext(), "User saved on Favorite Page", Toast.LENGTH_SHORT).show()
                item.isVisible = false
    ...
    override fun onViewCreated(view: View, savedInstanceState: Bundle?) {
        ...
        binding.viewPager.adapter =
            FollowTabPagerAdapter(user.username, childFragmentManager, lifecycle)
