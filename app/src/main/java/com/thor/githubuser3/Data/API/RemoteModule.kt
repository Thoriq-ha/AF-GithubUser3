    ...
    single {
        val okhttp: OkHttpClient = OkHttpClient.Builder()
            ...
            .addInterceptor { chain ->
                ...
                request.addHeader("Authorization", BuildConfig.TOKEN)
...
val errorHandleModule = module {
    single(createdAtStart = true) { ErrorHandler(androidApplication()) }
}